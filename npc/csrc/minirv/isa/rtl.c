...
static uint32_t rtl_halt = 0, rtl_check = 0, rtl_illegal = 0;
...
uint32_t rtl_illegal_val(){ return rtl_illegal; }
...
int isa_exec_once(Decode *s) {
  ...
  if (rtl_illegal_val()) invalid_inst(s->pc);
